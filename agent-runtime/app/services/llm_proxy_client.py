...
class LLMProxyClient:
    ...
    async def chat_completion(self, *, model: str, messages: List[dict], tools: Optional[list] = None, stream: bool = False, extra_payload: Optional[dict]=None) -> dict:
        """
        ...
        logger.debug(f"[LLMProxyClient] Response {response.status_code}, body startswith: {str(response.text)[:128]}")
