...
class MultiAgentOrchestrator:
    ...
    async def process_message(
        ...
        Note:
            Uses SessionLockManager to prevent race conditions when
            multiple requests access the same session concurrently.
        """
        ...
        async with session_lock_manager.lock(session_id):
            ...
            if agent_type:
                if context.current_agent != agent_type:
                    ...
                    # Publish agent switched event (context updated by AgentContextSubscriber)
